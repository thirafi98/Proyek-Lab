...
namespace parsing_project
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(parsing_project.control.Resource1.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(parsing_project.control.Resource1.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(parsing_project.control.Resource1.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(parsing_project.control.Resource1.TurnCoordinatorMarks);
