...
namespace parsing_project
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(parsing_project.control.Resource1.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(parsing_project.control.Resource1.AirSpeedNeedle);
