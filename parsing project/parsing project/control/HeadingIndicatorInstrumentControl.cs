...
namespace parsing_project
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(parsing_project.control.Resource1.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(parsing_project.control.Resource1.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(parsing_project.control.Resource1.HeadingIndicator_Aircraft);        
