...
namespace parsing_project
{
    class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(parsing_project.control.Resource1.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(parsing_project.control.Resource1.VerticalSpeedNeedle);
