...
namespace parsing_project
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(parsing_project.control.Resource1.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(parsing_project.control.Resource1.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(parsing_project.control.Resource1.Maquette_Avion);
