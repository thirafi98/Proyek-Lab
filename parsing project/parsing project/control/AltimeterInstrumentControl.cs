...
namespace parsing_project
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(parsing_project.control.Resource1.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(parsing_project.control.Resource1.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(parsing_project.control.Resource1.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(parsing_project.control.Resource1.Bandeau_Dérouleur);
