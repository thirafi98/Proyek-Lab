...
namespace milf
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(milf.control.Resource1.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(milf.control.Resource1.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(milf.control.Resource1.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(milf.control.Resource1.TurnCoordinatorMarks);
