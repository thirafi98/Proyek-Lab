...
namespace milf
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(milf.control.Resource1.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(milf.control.Resource1.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(milf.control.Resource1.Maquette_Avion);
