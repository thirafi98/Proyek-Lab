...
namespace milf
{
    class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(milf.control.Resource1.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(milf.control.Resource1.VerticalSpeedNeedle);
