...
namespace milf
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(milf.control.Resource1.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(milf.control.Resource1.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(milf.control.Resource1.HeadingIndicator_Aircraft);        
